...
public class ViewActivity extends AppCompatActivity implements SearchView.OnQueryTextListener{
    ...
    public static final String URL = "http://192.168.43.244/Halal/";
    //public static final String URL = "http://halalbpjph2018.000webhostapp.com/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Data Sertifikasi Halal");
    ...
    public boolean onCreateOptionsMenu(android.view.Menu menu) {
        ...
        searchView.setQueryHint("Cari Data Halal");
